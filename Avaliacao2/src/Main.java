...
class Pedido {
    ...
    public double calculaTotalPagar() {
        ...
        for (PedidoItem item : itensPedido) {
            precoTotal += item.getPrecoIngresso() * item.getQtdeIngresso();
        }
        return precoTotal;
    }
    }
...
public class Main {
    public static void main(String[] args) {
        ...
        Evento evento1 = new Evento("Evento 1", new Date(), 50.0, "Show de Rock", 100, categoria1);
        Evento evento2 = new Evento("Evento 2", new Date(), 30.0, "Show de Pop", 200, categoria2);

        Pedido pedido1 = new Pedido(1);

        PedidoItem item1 = new PedidoItem("Evento 1", 2, 50.0);
        PedidoItem item2 = new PedidoItem("Evento 2", 1, 40.0);
        ...
        if (evento2.buscarEvento(new Evento(item1.getNomeEvento(), null, 0, null, 0, null))) {
            pedido1.getItensPedido().add(item2);
            item1.atualizaEstoqueIngresso();
        }
        ...
        System.out.println("Valor total a pagar do Pedido 1: " + totalPagarPedido1);
